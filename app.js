...
function sumArray(testArray){ //eslint-disable-line
  var math = sum(testArray[0], sum(testArray[1], testArray[2])[0])[0];
  // var math = sum(testArray[0], testArray[1])[0];
  // var math1 = sum(math, testArray[2])[0];
  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + math + ' is their sum.';
  return [math, message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + math + '.';
  return [math, message];
}
